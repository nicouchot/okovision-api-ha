...
<?php
                        $panels = [
                            ['id' => 'FA0_L_mittlere_laufzeit',       'key' => 'CAPPL:FA[0].L_mittlere_laufzeit',       'action' => '', 'savable' => false, 'default' => '--'],
                            ['id' => 'FA0_L_brennerstarts',           'key' => 'CAPPL:FA[0].L_brennerstarts',           'action' => '', 'savable' => false, 'default' => '--'],
                            ['id' => 'FA0_L_brennerlaufzeit_anzeige', 'key' => 'CAPPL:FA[0].L_brennerlaufzeit_anzeige', 'action' => '', 'savable' => false, 'default' => '--'],
                            ['id' => 'FA0_L_anzahl_zuendung',         'key' => 'CAPPL:FA[0].L_anzahl_zuendung',         'action' => '', 'savable' => false, 'default' => '--'],
                        ];
                        foreach ($panels as $p) {
                            extract($p);
...
<?php
                        $panels = [
                            ['id' => 'hk0_raumtemp_heizen',     'key' => 'CAPPL:LOCAL.hk[0].raumtemp_heizen',     'action' => 'change', 'savable' => true, 'default' => '--'],
                            ['id' => 'hk0_raumtemp_absenken',   'key' => 'CAPPL:LOCAL.hk[0].raumtemp_absenken',   'action' => 'change', 'savable' => true, 'default' => '--'],
                            ['id' => 'hk0_heizkurve_steigung',  'key' => 'CAPPL:LOCAL.hk[0].heizkurve_steigung',  'action' => 'change', 'savable' => true, 'default' => '--'],
                            ['id' => 'hk0_heizkurve_fusspunkt', 'key' => 'CAPPL:LOCAL.hk[0].heizkurve_fusspunkt', 'action' => 'change', 'savable' => true, 'default' => '--'],
                            ['id' => 'hk0_heizgrenze_heizen',   'key' => 'CAPPL:LOCAL.hk[0].heizgrenze_heizen',   'action' => 'change', 'savable' => true, 'default' => '--'],
                            ['id' => 'hk0_heizgrenze_absenken', 'key' => 'CAPPL:LOCAL.hk[0].heizgrenze_absenken', 'action' => 'change', 'savable' => true, 'default' => '--'],
                        ];
                        foreach ($panels as $p) {
                            extract($p);
                            include __DIR__.'/_templates/rt/sensor_panel.php';
...
<?php
                        $panels = [
                            ['id' => 'hk0_vorlauftemp_max',                 'key' => 'CAPPL:LOCAL.hk[0].vorlauftemp_max',                 'action' => 'change', 'savable' => true, 'default' => '--'],
                            ['id' => 'hk0_vorlauftemp_min',                 'key' => 'CAPPL:LOCAL.hk[0].vorlauftemp_min',                 'action' => 'change', 'savable' => true, 'default' => '--'],
                            ['id' => 'hk0_ueberhoehung',                    'key' => 'CAPPL:LOCAL.hk[0].ueberhoehung',                    'action' => 'change', 'savable' => true, 'default' => '--'],
                            ['id' => 'hk0_mischer_max_auf_zeit',            'key' => 'CAPPL:LOCAL.hk[0].mischer_max_auf_zeit',            'action' => 'change', 'savable' => true, 'default' => '--'],
                            ['id' => 'hk0_mischer_max_aus_zeit',            'key' => 'CAPPL:LOCAL.hk[0].mischer_max_aus_zeit',            'action' => 'change', 'savable' => true, 'default' => '--'],
                            ['id' => 'hk0_mischer_max_zu_zeit',             'key' => 'CAPPL:LOCAL.hk[0].mischer_max_zu_zeit',             'action' => 'change', 'savable' => true, 'default' => '--'],
                            ['id' => 'hk0_mischer_regelbereich_quelle',     'key' => 'CAPPL:LOCAL.hk[0].mischer_regelbereich_quelle',     'action' => 'change', 'savable' => true, 'default' => '--'],
                            ['id' => 'hk0_mischer_regelbereich_vorlauf',    'key' => 'CAPPL:LOCAL.hk[0].mischer_regelbereich_vorlauf',    'action' => 'change', 'savable' => true, 'default' => '--'],
                            ['id' => 'hk0_quellentempverlauf_anstiegstemp', 'key' => 'CAPPL:LOCAL.hk[0].quellentempverlauf_anstiegstemp', 'action' => 'change', 'savable' => true, 'default' => '--'],
                            ['id' => 'hk0_quellentempverlauf_regelbereich', 'key' => 'CAPPL:LOCAL.hk[0].quellentempverlauf_regelbereich', 'action' => 'change', 'savable' => true, 'default' => '--'],
                        ];
                        foreach ($panels as $p) {
                            extract($p);
                            include __DIR__.'/_templates/rt/sensor_panel.php';
...
<?php
                        $panels = [
                            ['id' => 'FA0_pe_kesseltemperatur_soll',   'key' => 'CAPPL:FA[0].pe_kesseltemperatur_soll',   'action' => 'change', 'savable' => true,  'default' => '--'],
                            ['id' => 'FA0_pe_abschalttemperatur',      'key' => 'CAPPL:FA[0].pe_abschalttemperatur',      'action' => 'change', 'savable' => true,  'default' => '--'],
                            ['id' => 'FA0_pe_einschalthysterese_smart','key' => 'CAPPL:FA[0].pe_einschalthysterese_smart','action' => 'change', 'savable' => true,  'default' => '--'],
                            ['id' => 'FA0_pe_kesselleistung',          'key' => 'CAPPL:FA[0].pe_kesselleistung',          'action' => '',       'savable' => false, 'default' => '--'],
                        ];
                        foreach ($panels as $p) {
                            extract($p);
                            include __DIR__.'/_templates/rt/sensor_panel.php';
        ...
        <?php $confirmId = 'btConfirmSensor'; include __DIR__.'/_templates/rt/modal_change.php'; ?>
